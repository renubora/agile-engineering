...
public class QuantityTest {
    ...
    @Test
    public void TwoTwelveFahrenheitShouldEqual100Celsius() {
        assertEquals(new Quantity(Unit.FAHRENHEIT, 212), new Quantity(Unit.CELSIUS, 100));
    }

    @Test
    public void TwentyTwoFahrenheitShouldNotEqual100Celsius() {
        assertNotSame(new Quantity(Unit.FAHRENHEIT, 22), new Quantity(Unit.CELSIUS, 100));
    }

    @Test
    public void TenYardsShouldBeGreaterThanTwoFeet() {
        assert (new Quantity(Unit.YARDS,10).greaterthan(new Quantity(Unit.FEET, 2)));
    }
